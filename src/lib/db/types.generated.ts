// Generated from Supabase project qpbogzkdpynhhqmaradu (lectual-prod).
// Regenerate with the Supabase MCP generate_typescript_types tool. Do not edit by hand.
  ...
  public: {
    Tables: {
      ...
      crm_attorney: {
        ...
        Relationships: [
          {
            foreignKeyName: "crm_attorney_org_id_fkey"
            columns: ["org_id"]
            isOneToOne: false
            referencedRelation: "crm_org"
            referencedColumns: ["id"]
      ...
      crm_litigation_detail: {
        ...
        Relationships: [
          {
            foreignKeyName: "crm_litigation_detail_matter_fk"
            columns: ["matter_id", "org_id"]
            isOneToOne: false
            referencedRelation: "crm_matter"
            referencedColumns: ["id", "org_id"]
      ...
      crm_matter_stage: {
        Row: {
          ...
          order_index: number
          org_id: string
          phase: Database["public"]["Enums"]["crm_matter_phase"] | null
          updated_at: string
      ...
      platform_admin_audit: {
        ...
        Relationships: [
          {
            foreignKeyName: "platform_admin_audit_org_id_fkey"
            columns: ["org_id"]
            isOneToOne: false
            referencedRelation: "crm_org"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      org_admin_lookup_user_id: { Args: { p_email: string }; Returns: string }
      ...
      provision_org_for_owner: {
        Args: {
          ...
          p_queue_org_key?: string
          p_slug: string
        }
        Returns: string
      }
      revoke_member_sessions: { Args: { p_user_id: string }; Returns: number }
